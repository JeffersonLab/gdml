...
./configure --with-platform=${PLATFORM} \
	    --with-xercesc=${LCGEXT}/XercesC/2.3.0/${PLATFORM} \
            ...
            --with-geant4=${LCGEXT}/geant4/7.1.p01/${PLATFORM} \
            --with-geant4-include=${LCGEXT}/geant4/7.1.p01/share/include \
            --with-geant4-libdir=${LCGEXT}/geant4/7.1.p01/${PLATFORM}/lib \
